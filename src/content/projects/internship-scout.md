...
summary:
  ...
  result: "Two deployments, a public demo and a private instance against the live search. Idempotent runs, with Vitest unit and integration tests gating CI; a Playwright end-to-end spec runs locally."
featured: true
order: 1
---
