export const site = {
  ...
  awards: [
    ...
    { title: 'AI Fluency for Nonprofits', detail: 'Anthropic (May 2026)' },
    { title: 'Responsible Conduct of Research (All Disciplines)', detail: 'CITI Program (2025–2029)' },
    { title: 'Conflicts of Interest in Research Training', detail: 'CITI Program (2026–2029)' },
    { title: 'Specialized Certificate in Data Science and Artificial Intelligence', detail: 'Universidad de San Martín de Porres (Aug 2025)' },
